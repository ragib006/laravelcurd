...
<!---- show all category in add category dropdown  ---  >
  ...
  <form enctype="multipart/form-data" role="form" method="post" action="{{url('/add_student_form_action_route')}}">
           ...
           <div class="form-group">
                    ...
                    <input style="width:500px;" type="text" name="student_name" class="form-control" id="exampleInputEmail1" placeholder="Enter student name" required>
           </div>

           <div class="form-group">
                    <label for="exampleInputEmail1">Student Id</label>
                    <input style="width:500px;" type="text" name="student_id" class="form-control" id="exampleInputEmail1" placeholder="Enter student id" required>
           </div>
